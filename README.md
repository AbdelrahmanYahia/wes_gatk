...
- [Nirvana](https://illumina.github.io/NirvanaDocumentation/) and [Annovar](https://www.openbioinformatics.org/annovar/annovar_download_form.php) Annotation
...
- progress bar of the analysis (use argument `--parse-snakemake-output` [see below](#Advanced-Parameters))
